...
import { CourierImageUpload } from '../../components/index.js';
import { useImageUpload } from '../../utils/index.js';
...
const useStepsFormList = ({ stepsForm }: UseStepsFormList) => {
  ...
  const imageUploadOnChangeHandler = async (
    ...
    try {
      ...
      console.log(
        '🚀 ~ create.tsx:208 ~ imageUploadOnChangeHandler ~ error:',
        error,
      );
    }
  };
            ...
            <CourierImageUpload
              ...
              inputProps={{
                ...
                onChange: (event: React.ChangeEvent<HTMLInputElement>) => {
                  imageUploadOnChangeHandler(event).catch((error) => {
                    console.error(error);
                  });
                },
              }}
        ...
        <Controller
          ...
          render={({ field }) => (
            <Autocomplete
              ...
              getOptionLabel={(item: { model: string; id: number }) => {
